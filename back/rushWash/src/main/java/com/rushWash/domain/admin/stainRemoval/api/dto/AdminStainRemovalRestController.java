package com.rushWash.domain.admin.stainRemoval.api.dto;

import com.rushWash.common.response.ApiResponse;
import com.rushWash.domain.admin.stainRemoval.api.dto.request.AdminStainRemovalRequest;
import com.rushWash.domain.admin.stainRemoval.api.dto.request.AdminStainRemovalUpdateRequest;
import com.rushWash.domain.admin.stainRemoval.service.AdminStainRemovalService;
...
@RequestMapping("/admin/stain-removal")
