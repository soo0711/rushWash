package com.rushWash.domain.api.admin.fabricSofteneres.api;

import com.rushWash.common.response.ApiResponse;
import com.rushWash.domain.api.admin.fabricSofteneres.api.dto.request.AdminFabricSoftenerDeleteRequest;
import com.rushWash.domain.api.admin.fabricSofteneres.api.dto.request.AdminFabricSoftenerRequest;
import com.rushWash.domain.api.admin.fabricSofteneres.api.dto.request.AdminFabricSoftenerUpdateRequest;
import com.rushWash.domain.api.admin.fabricSofteneres.service.AdminFabricSoftenerService;
...
@RequestMapping("/api/admin/fabric-softeners")
